                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 ...
                                 <li class="active"><a href={{route('books.index')}}>Our Books</a></li>
            ...
            <div class="row box">
               ...
               <div class="col-md-6 offset-md-3">
                  ...
                  @foreach ($books as $books)
                            <h3>ID: {{$books->id}}</h3>
                             <h3><b>Name: {{$books->name}}</b></h3>
                             <p>Description: {{$books->description}}</p>
                             <p>Price: {{$books->price}}</p>
                             <p>Quantity: {{$books->quantity}}</p>
                             <p>Category ID:{{$books->list_id}}</p>
                             <a href="{{route('books.show', ['books'=>$books->id])}}" type="button" class="btn btn-success" >SHOW</a>
                             <a href="{{route('books.update', ['books'=>$books->id])}}" type="button" class="btn btn-info" >UPDATE</a>
                             <a href="{{route('books.delete', ['books'=>$books->id])}}" type="button" class="btn btn-danger" >DELETE</a>
                             <hr>
                  @endforeach
                            </div>
                          </div>
